<script>
  import { LightSwitch, ThemeSelect } from "$lib";
...
<div class="details details-t p-2">
  <div class="summary btn btn-lg btn-block px-2 lg:px-4" role="button" tabindex="0">
  ...
  >
    ...
    <li class="py-0 flex justify-between items-center">
      <h2>Dark Mode</h2>
      <LightSwitch />
    </li>
    <li>
